...
urlpatterns = patterns('',
    ...
    url(r'^calendrier/(?P<year>\d{4})/(?P<trim>[1-4])$', views.calendrier, name='calendrier'),
    ...
    url(r'^en/calendar/(?P<year>\d{4})$', views.calendar, name='calendar'),
    url(r'^en/calendar/(?P<year>\d{4})/(?P<trim>[1-4])$', views.calendar, name='calendar'),
